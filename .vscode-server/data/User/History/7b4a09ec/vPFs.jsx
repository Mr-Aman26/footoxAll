                ...
                <div className="ps-product__column" key={item._id}>
                  <div className="ps-shoe mb-30">
                    <div className="ps-shoe__thumbnail">
                      ...
                      <a className="ps-shoe__favorite" href="#"><i className="ps-icon-heart" /></a><img style ={{height : '420px'}}src={item.image?.[0][0]} alt="" /><a className="ps-shoe__overlay" onClick={() => handleDes(item.productId)} />
                    </div>
                    <div className="ps-shoe__content">
                      <div className="ps-shoe__variants">
                        <div className="ps-shoe__variant normal"><img  src={item.image?.[0][1]} alt="" /><img width="55" src={item.image?.[0][2]}alt="" /><img width="55" src={item.image?.[0][3]} alt="" /><img width="55" src={item.image?.[0][4]} alt="" /></div>

                  ...
                  <div className="ps-shoe mb-30">
                    ...
                    <div className="ps-shoe__content">
                      <div className="ps-shoe__variants">
                        <div className="ps-shoe__variant normal"><img width="55" src={item.image?.[0][1]} alt="" /><img width="55" src={item.image?.[0][2]}alt="" /><img width="55" src={item.image?.[0][3]} alt="" /><img width="55" src={item.image?.[0][4]} alt="" /></div>

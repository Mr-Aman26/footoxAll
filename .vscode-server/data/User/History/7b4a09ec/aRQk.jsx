                  ...
                  <div className="ps-shoe mb-30">
                    ...
                    <div className="ps-shoe__content">
                      <div className="ps-shoe__variants">
                        <div className="ps-shoe__variant normal"><img width="55" src={item.image?.[1][0]} alt="" /><img width="55" src={item.image?.[2]}alt="" /><img width="55" src={item.image?.[3]} alt="" /><img width="55" src={item.image?.[4]} alt="" /></div>

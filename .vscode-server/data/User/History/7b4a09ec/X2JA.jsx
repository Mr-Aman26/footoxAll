                  ...
                  <div className="ps-shoe mb-30">
                    ...
                    <div className="ps-shoe__content">
                      <div className="ps-shoe__variants">
                        <div className="ps-shoe__variant normal"><img  style ={{height : '55px',width="55" }} src={item.image?.[0][1]} alt="" /><img style ={{height : '55px',width="55" }} src={item.image?.[0][2]}alt="" /><img style ={{height : '55px',width="55" }} src={item.image?.[0][3]} alt="" /><img style ={{height : '55px',width="55" }} src={item.image?.[0][4]} alt="" /></div>

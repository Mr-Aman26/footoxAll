                                ...
                                <div className="ps-shoe__variant normal owl-carousel owl-theme owl-loaded" key = {item.productId}>
                                  <div className='owl-stage-outer' key = {item.productId}>
                                    <OwlCarousel items={4} autoplay={true} dots={false} nav={false} key = {item.productId}>
                                      <img key = {item.productId} src={item.image?.[0][0]} alt="" style ={{height : '40px'}}/><img key = {item.productId} src={item.image?.[0][1]} alt="" /><img key = {item.productId} src={item.image?.[0][2]} alt="" /><img key = {item.productId} src={item.image?.[0][3]} alt="" />
                                    </OwlCarousel></div></div>

                          ...
                          <div className="ps-shoe mb-30" key = {item.productId}>
                            ...
                            <div className="ps-shoe__content"key = {item.productId}>
                                ...
                                <div className="ps-shoe__variant normal owl-carousel owl-theme owl-loaded"key = {item.productId}>
                                  <div className='owl-stage-outer'key = {item.productId}>
                                    <OwlCarousel items={4} autoplay={true} dots={false} nav={false}key = {item.productId}>
                                      <imgkey = {item.productId} src={item.image?.[0][0]} alt="" /><imgkey = {item.productId} src={item.image?.[0][1]} alt="" /><img key = {item.productId} src={item.image?.[0][2]} alt="" /><img key = {item.productId} src={item.image?.[0][3]} alt="" />
                                    </OwlCarousel></div></div>
                              ...
                              <div className="ps-shoe__detail"key = {item.productId} style={{textAlign:'left'}}>
                                ...
                                {/* <pkey = {item.productId} className="ps-shoe__categories"><a = {item.productId} href="#">
                                  {item.gender} shoes</a>,<a = {item.productId} href="#"> Nike</a>,<a = {item.productId} href="#"> Jordan</a></pkey> */}
                                  <spankey = {item.productId} className="ps-shoe__price">
                                  <del = {item.productId}>₹{item.original_price}</del> ₹{item.selling_price}</spankey>
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div className="ps-shoe mb-30"key = {item.productId}>
                            ...
                            <divkey = {item.productId} className="ps-shoe__content">
                              <divkey = {item.productId} className="ps-shoe__variants">
                                <divkey = {item.productId} className="ps-shoe__variant normal owl-carousel owl-theme owl-loaded">
                                  <divkey = {item.productId} className='owl-stage-outer'>
                              ...
                              <divkey = {item.productId} className="ps-shoe__detail" style={{textAlign:'left'}}>
                                <divkey = {item.productId} style={{inlineSize: "150px",  overflowWrap: "break-word"}}><a = {item.productId} className="ps-shoe__name" onClick={() => handleDes(item.productId)}>{item.productName}</a></divkey>
                                {/* <pkey = {item.productId} className="ps-shoe__categories"><a = {item.productId} href="#">
                                  {item.gender} shoes</a>,<a = {item.productId} href="#"> Nike</a>,<a = {item.productId} href="#"> Jordan</a></pkey> */}
                                  <spankey = {item.productId} className="ps-shoe__price">
                                  <del = {item.productId}>₹{item.original_price}</del> ₹{item.selling_price}</spankey>
                    ...
                    {products.map((item) => {
                      ...
                      <div className="grid-item shoes"key = {item.productId}>
                        <div className="grid-item__content-wrapper"key = {item.productId}>
                          <div className="ps-shoe mb-30"key = {item.productId}>
                            <div className="ps-shoe__thumbnail"key = {item.productId}><akey = {item.productId} className="ps-shoe__favorite" href="#"><i = {item.productId} className="ps-icon-heart"></i></akey><imgkey = {item.productId} src={item.image?.[0]} alt="" /><a = {item.productId} className="ps-shoe__overlay"  onClick={() => handleDes(item.id)}></a>
                            </div>
                            <divkey = {item.productId} className="ps-shoe__content">
                              <divkey = {item.productId} className="ps-shoe__variants">
                              <divkey = {item.productId} className="ps-shoe__variant normal owl-carousel owl-theme owl-loaded">
                                <div = {item.productId} className='owl-stage-outer'>
                                  <OwlCarousel key={item.productId} items={4} autoplay={true} dots={false} nav={false}>
                                    <imgkey = {item.productId} src={item.image?.[0][0]} alt="" /><imgkey = {item.productId} src={item.image?.[0][1]} alt="" /><imgkey = {item.productId} src={item.image?.[0][2]} alt="" /><imgkey = {item.productId} src={item.image?.[0][3]} alt="" />
                                  </OwlCarousel></div></divkey>
                              </div>
                              <divkey = {item.productId} className="ps-shoe__detail" style={{textAlign:'left'}}>
                                <divkey = {item.productId} style={{inlineSize: "150px",  overflowWrap: "break-word"}}><a = {item.productId} className="ps-shoe__name" href="#" >{item.name}</a></divkey>
                                {/* <pkey = {item.productId} className="ps-shoe__categories"><a = {item.productId} href="#">
                                  {item.gender} shoes</a>,<a = {item.productId} href="#"> Nike</a>,<a = {item.productId} href="#"> Jordan</a></pkey> */}
                                  <spankey = {item.productId} className="ps-shoe__price">
                                  <del = {item.productId}>₹{item.original_price}</del> ₹{item.final_price}</spankey>
                              </div>
                            </div>
                          </div>
                        </div>

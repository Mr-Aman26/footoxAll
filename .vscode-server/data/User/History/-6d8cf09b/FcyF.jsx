                                ...
                                <div className="ps-shoe__variant normal owl-carousel owl-theme owl-loaded" key = {item.productId}>
                                  <div className='owl-stage-outer' key = {item.productId}>
                                    <OwlCarousel items={4} autoplay={true} dots={false} nav={false} key = {item.productId}>
                                      <img key = {item.productId} src={item.image?.[0][0]} alt="" style ={{height : '60px', width : '60px'}}/><img style ={{height : '60px'}} key = {item.productId} src={item.image?.[0][1]} alt="" /><img style ={{height : '60px'}} key = {item.productId} src={item.image?.[0][2]} alt="" /><img style ={{height : '60px'}} key = {item.productId} src={item.image?.[0][3]} alt="" />
                                    </OwlCarousel></div></div>

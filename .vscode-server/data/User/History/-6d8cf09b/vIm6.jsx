                        ...
                        <div className="grid-item__content-wrapper" key = {item.id} style={{minHeight: "300px",position: 'relative'}}>
                          <div className="ps-shoe mb-30" key = {item.id}>
                            <div className="ps-shoe__thumbnail" key = {item.id}>
                              ...
                              <a className="ps-shoe__favorite" key = {item.id} href="#"><i = {item.productId} className="ps-icon-heart"></i></a><img key = {item.id} src={item.image?.[0][0]} alt="" /><a = {item.productId} className="ps-shoe__overlay" onClick={() => handleDes(item.productId)}></a>
                            </div>
                    ...
                    {products.map((item) => {
                      ...
                      <div className="grid-item shoes" key = {item.id}>
                        <div className="grid-item__content-wrapper" key = {item.id}>
                          <div className="ps-shoe mb-30" key = {item.id}>
                            <div className="ps-shoe__thumbnail" key = {item.id}><a = {item.productId} className="ps-shoe__favorite" href="#"><i = {item.productId} className="ps-icon-heart"></i></a><img key = {item.id} src={item.image?.[0]} alt="" /><a = {item.productId} className="ps-shoe__overlay"  onClick={() => handleDes(item.id)}></a>
                            </div>
                            <div key = {item.id} className="ps-shoe__content">
                              <div key = {item.id} className="ps-shoe__variants">
